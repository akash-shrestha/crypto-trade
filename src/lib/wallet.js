...
let _provider = new ethers.providers.JsonRpcProvider(CHAINDATA[1313161555].rpc);
provider.set(_provider);
chainId.set(1313161555);
let _walletConnect;
...
export async function connectWalletConnect() {
  ...
  async function scriptLoaded() {
    _walletConnect = new WalletConnectProvider.default({
      rpc: {
        313161555: CHAINDATA[313161555].rpc,
      },
    });
          ...
          params: [
            {
              chainId: "0x4e454153",
              chainName: "Aurora",
              rpcUrls: [CHAINDATA[313161555]["rpc"]],
              nativeCurrency: {
                name: "ETH",
                symbol: "ETH",
                decimals: 18,
              },
              blockExplorerUrls: [CHAINDATA[313161555]["explorer"]],
            },
          ],
        });
      } catch (addError) {
