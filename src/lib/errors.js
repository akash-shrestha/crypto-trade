...
const DEFAULT_ERROR =
  "Unidentified error. Check your browser console for more details.";
...
const ERROR_STRINGS = {
  ...
  "!cooldown":
    "You have to wait at least 1 hour after depositing before withdrawing.",
  "!empty": "The pool is empty.",
  "!utilization":
    "Pool utilization ratio is too high. Please try again later or with a smaller position size.",
  "!available-balance":
    "Not enough non-utilized balance is available in the pool. Please try again later or with a smaller amount.",
